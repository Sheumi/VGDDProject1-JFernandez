...
public class PlayerAttackInfo
{
    ...
    [SerializeField]
    [Tooltip("How long the waitbefore this attack should be activated after the button is pressed")]
    ...
    [SerializeField]
    [Tooltip("How long to wait before the player can do anything else")]
